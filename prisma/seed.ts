...
async function main() {
  ...
  // 7. Reviews are user-generated only — the seed intentionally creates none,
  // so every rating shown on the storefront comes from a real customer.
  ...
  console.log(`Reviews:    0 (user-generated only)`);
