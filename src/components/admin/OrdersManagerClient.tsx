            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-muted/40 rounded-lg space-y-1.5 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatCurrency(detail.subtotal, locale)}</span>
                </div>
                {detail.discount > 0 && (
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t('discount')}</span>
                    <span className="font-medium text-red-600">-{formatCurrency(detail.discount, locale)}</span>
                  </div>
                )}
                <div className="flex justify-between">
                  <span className="text-muted-foreground">{t('shippingCost')}</span>
                  <span className="font-medium">
                    {detail.shippingCost != null ? formatCurrency(detail.shippingCost, locale) : '—'}
                  </span>
                </div>
