...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    try {
      whatsappMessage = await generateOrderMessage(
        {
      ...
      console.error('WhatsApp notification generation failed:', error);
    }
    ...
    return NextResponse.json({
      ...
      ...(whatsappUrl !== undefined && { whatsappUrl, message: whatsappMessage }),
    });
  } catch (error: unknown) {
