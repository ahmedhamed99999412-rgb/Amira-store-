...
import { DeferredStoreRuntime } from '@/components/store/DeferredStoreRuntime';
import '../globals.css';
...
export default async function LocaleLayout({
  ...
  return (
    <div
      lang={lang}
      dir={dir}
      className={`${inter.variable} ${playfair.variable} ${tajawal.variable} ${amiri.variable} min-h-screen flex flex-col`}
      style={{
        fontFamily:
          locale === 'ar'
    ...
    >
      <NextIntlClientProvider>
        <AuthProvider>
          {children}
          <DeferredStoreRuntime locale={locale} />
        </AuthProvider>
      </NextIntlClientProvider>
